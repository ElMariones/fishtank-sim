...
**Updated:** 13 September 2026 · **Build:** 0.1.0 research lab · **M1:** FS-101 DONE (`fe138d4`); FS-102 DONE (`b0fd927`); FS-103–107 open. User requests FS-108/FS-109 implemented; see the backlog for push status.
...
- 26 automated tests (core and anatomy); production build; browser verification of representative interactions.
...
**FS-108/FS-109, 13 September 2026, Windows 11, Node 22.18.0, npm 10.9.3:**
...
**FS-102, 13 September 2026, same environment:**
...
- Browser: Visual fixtures rendered genome v1 → development v1 → anatomy v2 → renderer v2, 0 / 858 anatomy failures, stress cards with listed adjustments, and the v1/v2 comparison table. After a clean reload, opening the surface added no console errors. The only errors seen were Fast Refresh hook-dependency warnings raised while editing a mounted component.
