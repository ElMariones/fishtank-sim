...
| FS-118 | IN REVIEW | Instant tank switching: persistent motion worker and render loop, shared and idle-warmed scene layers, tiled substrates, deferred collection with queued cached portraits, and delayed loading indicators on the tank, collection and rail. Evidence: [TESTING](TESTING.md#fs-118-tank-switching). |
