...
| ID | Pri | Days | Role | Depends | Task and acceptance |
|---|---|---:|---|---|---|
| FS-701 | REVIEW | 4 | Rendering/runtime | FS-505 FS-605 | Canvas vs PixiJS spike and chosen renderer cache/LOD; record device, frame timings and memory. Spike complete, renderer unchanged; awaiting push. [evidence](research/FS-701-RENDERER-SPIKE.md) |
