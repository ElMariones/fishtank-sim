...
M1's roadmap gate, M2 (`6a69695`), the FS-113 appearance request (`2436fbf`), the FS-301 water model (`4f61d8b`) and FS-302 life stages (`5821f46`) are pushed. FS-303 is DONE, pushed `e7aefc1`; next is FS-304 spatial hashing and footprints. Health decay and feeding effects stay with FS-305.
...
- FS-303 — DONE: implementation and tests pushed as `e7aefc1`. FS-304–307 remain open.
